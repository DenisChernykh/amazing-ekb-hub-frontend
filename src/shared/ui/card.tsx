...
/**
 * Рендерит базовую card surface проекта.
 */
function Card({
  className,
  size = 'default',
...
/**
 * Рендерит верхнюю область карточки.
 */
...
/**
 * Рендерит нижнюю область карточки.
 */
